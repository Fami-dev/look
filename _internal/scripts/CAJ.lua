...
local capturedWinTokenRandom = nil
...
oldNamecall = hookmetamethod(game, "__namecall", function(self, ...)
    ...
    if self == proMgsRemote and method == "FireServer" and args[1] then
        ...
        elseif eventId == "\233\162\134\229\143\150\230\165\188\233\161\182wins" or eventId == "\233\162\134\229\143\150\230\165\188\233\161\182MagicToken" then
            capturedWinTokenRandom = args[2]
        end
    end
                ...
                task.spawn(function()
                    ...
                    while autoFarmState.AutoCoins and player do
                        ...
                        if winsTokenTimer >= 15 and proMgsRemote then
                            if autoFarmState.AutoWins and capturedWinTokenRandom then
                                task.wait(1)
                                pcall(function() proMgsRemote:FireServer("\233\162\134\229\143\150\230\165\188\233\161\182wins", capturedWinTokenRandom) end)
                            end
                            winsTokenTimer = 0
                        end
                        task.wait(0.1)
...
-- Auto Crystal Logic with robust initialization
        ...
        task.spawn(function()
            ...
            if magicTokenValue and player then
                ...
                magicTokenValue.Changed:Connect(function(newValue)
                    if autoFarmState.AutoCoins and autoFarmState.AutoCrystal and capturedWinTokenRandom and proMgsRemote and player then
                        if newValue == 1 and lastValue == 0 then
                            ...
                            crystalTask = task.spawn(function()
                                while magicTokenValue.Value == 1 and autoFarmState.AutoCoins and autoFarmState.AutoCrystal and player do
                                    pcall(function()
                                        proMgsRemote:FireServer("\233\162\134\229\143\150\230\165\188\233\161\182MagicToken", capturedWinTokenRandom)
                                    end)
                                    task.wait(0.5)
                                end
                            end)
