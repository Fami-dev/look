...
local function InitializeMainScript()
    ...
    local Tabs = {
        ...
        AutoFuse = Window:Tab({ Title = "Auto Fuse", Icon = "combine", ShowTabTitle = true }),
    ...
    do
        ...
        local function teleportAndOpenUI(locationName, targetPosition, uiName)
            ...
            pcall(function()
                ...
                if uiElement then
                    ...
                    warn("UI Element not found: " .. uiName)
                    rootPart.CFrame = originalCFrame
                end
            end)
        end
        ...
        Tabs.UI:Button({
            ...
            Callback = function()
                teleportAndOpenUI("Wing Shop", Vector3.new(-69, 3, -5004), "WingShop")
            end
        })
        ...
        Tabs.UI:Button({
            ...
            Callback = function()
                teleportAndOpenUI("Wing Enchant", Vector3.new(-6, 4, -4998), "WingEnchantment")
            end
        })
        ...
        Tabs.UI:Button({
            ...
            Callback = function()
                teleportAndOpenUI("Titan Machine", Vector3.new(9984, 3, -4), "Titan Pet")
            end
        })
        ...
        Tabs.UI:Button({
            ...
            Callback = function()
                teleportAndOpenUI("Enchant UI", Vector3.new(5017, 2, 23), "MagicPet")
            end
        })
    end
